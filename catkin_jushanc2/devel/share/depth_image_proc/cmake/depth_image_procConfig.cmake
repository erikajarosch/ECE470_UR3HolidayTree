...
if("TRUE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/ur3/catkin_jushanc2/src/lab2andDriver/drivers/camera_calibration/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/ur3/catkin_jushanc2/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/ur3/catkin_jushanc2/install)
...
if(NOT "/home/ur3/catkin_jushanc2/src/lab2andDriver/drivers/camera_calibration/image_pipeline/depth_image_proc/include " STREQUAL " ")
  set(depth_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/ur3/catkin_jushanc2/src/lab2andDriver/drivers/camera_calibration/image_pipeline/depth_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ur3/catkin_jushanc2/src/lab2andDriver/drivers/camera_calibration/image_pipeline/depth_image_proc/${idir}'.  ${_report}")
    endif()
